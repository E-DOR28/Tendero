	...
	<div class="global-container">
		...
		<div class="header">
			...
			<div class="header-title">
				...
				<label class="title2">Reporte de la semana</label>
			</div>
		</div>
			...
			<div class="content">
				...
				<div class="nav">
					<div class="topnav">
						...
						<a class="active" href="index.php?accion=listarReportesS">Ver reporte de la semana</a>
						<a href="index.php?accion=listarReportesM">Ver reporte del mes</a>
				...
				<div class="content-total">
					<br><br>
					<center><h2>REPORTE INGRESOS Y EGRESOS DE LOS ÚLTIMOS 7 DÍAS</h2></center>
					<center><h3><?php 
				
						setlocale(LC_ALL,"es_ES");
				        $hoy = strftime("%d de %B de %Y",time());
				        $fechaInicio = strftime("%d de %B", strtotime ( '-7 day' , time()));
