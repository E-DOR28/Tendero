	...
	<div class="global-container">
		...
		<div class="header">
			...
			<div class="header-title">
				...
				<label class="title2">Reporte del día</label>
			</div>
		</div>
		...
		<div class="content-container">
			...
			<div class="content">
				...
				<div class="nav">
					<div class="topnav">
						<a class="active" href="index.php?accion=listarReportesD">Ver reporte del día</a>
				...
				<div class="content-total">
					<br><br>
					<center><h2>REPORTE INGRESOS Y EGRESOS DEL DIA</h2></center>
					<center><h3><?php 
					setlocale(LC_ALL,"es_ES");
					echo ucwords(strftime("%A, %d de %B del %Y"));
					 ?></h3></center>
